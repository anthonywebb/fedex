...
function FedEx(args) {
  ...
  function buildLocationLookupRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      if (err) {
        return callback(err, null);
      }
      ...
      client.searchLocations(params, function(err, result) {
        if($scope.options.debug) {
          //console.log(util.inspect(parser.toJson(client.lastRequest, {coerce: false, object: true, sanitize: false}), {depth: null}));
        }
        if(err) {
  ...
  function handleLocationLookupResponse(res, callback) {
    return callback(null, res);
  }
  ...
  var resources = {
    rates: {f: buildRatesRequest, r: handleRatesResponse, wsdl: 'RateService_v28.wsdl', path: '/web-services', version: {ServiceId: 'crs', Major: 28, Intermediate: 0, Minor: 0}},
    ship: {f: buildShipRequest, r: handleShipResponse, wsdl: 'ShipService_v26.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 26, Intermediate: 0, Minor: 0}},
    track: {f: buildTrackingRequest, r: handleTrackingResponse, wsdl: 'TrackService_v19.wsdl', path: '/web-services', version: {ServiceId: 'trck', Major: 19, Intermediate: 0, Minor: 0}},
    ...
    freight_rates: {f: buildFreightRatesRequest, r: handleFreightRatesResponse, wsdl: 'RateService_v28.wsdl', path: '/web-services', version: {ServiceId: 'crs', Major: 28, Intermediate: 0, Minor: 0}},
    validate: {f: buildAddressValidationRequest, r: handleAddressValidationResponse, wsdl: 'AddressValidationService_v4.wsdl', path: '/web-services', version: {ServiceId: 'aval', Major: 4, Intermediate: 0, Minor: 0}},
    locations: {f: buildLocationLookupRequest, r: handleLocationLookupResponse, wsdl: 'LocationsService_v12.wsdl', path: '/web-services', version: {ServiceId: 'locs', Major: 12, Intermediate: 0, Minor: 0}},
  };
